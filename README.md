Для запуска необходимо создать БД PstgreSQL, подключить ее к проекту, выполнить код из файла находящегося в src/main/java/ru/obozhulkin/Onlineshop/sql/db.sql
